...
**אם נכשל:** דווח למשתמש. אל תמשיך לשלב הבא.

**הערה:** שלב זה מפיץ את הגרסה החדשה לטלפונים הניידים דרך Firebase Hosting.
...
| `firebase deploy --only hosting` | מפיץ את האפליקציה לפרודקשן |
