...
import { getPersonalRecords, PersonalRecord } from '@/lib/firebase/workoutHistory'
        ...
        <div className="space-y-3">
          {sortedRecords.map((record) => (
            <div
              ...
              className="bg-background-card border border-border-default rounded-xl p-4 hover:border-border-light transition-colors"
            >
              <div className="flex items-center gap-3">
                {/* Exercise Image */}
