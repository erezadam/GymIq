...
| 3 | "התמונה לא נוצרה" באדמין | ⚠️ אובחן, לא נסגר — השרת ייצר בהצלחה (2 drafts ב-image_ready); הכשל: **4 קריאות מקבילות זהות מהלקוח** לאותו draft (4×$0.105) + אי-הצגה ב-DraftPanel. נדרש: תיקון לקוח (מניעת דאבל-קליק/מירוץ) + שקילת guard אידמפוטנטי בשרת — משימה חדשה | לוג generateExerciseImage 13:46:52 (×4) |
