...
### תרחיש U: תכנון מהיר (Quick Plan)
```
1. [ ] פתח ExerciseLibrary ← לחץ "התחל אימון" מדשבורד
2. [ ] וודא שמופיע toggle עם שני tabs: "ספרייה" ו"תכנון מהיר"
3. [ ] לחץ על "תכנון מהיר"
4. [ ] וודא: Workout Mode selector (עכשיו/להיום/תאריך) נעלם
5. [ ] וודא: שדה כותרת חופשי מופיע בראש
6. [ ] וודא: הודעה "בחר תרגילים מהרשימה למטה" מוצגת
7. [ ] בחר 3 תרגילים מהרשימה
8. [ ] וודא: כל תרגיל מופיע ב-QuickPlanExerciseList עם stepper (ברירת מחדל 3 סטים)
9. [ ] שנה סטים: לחץ + ו- על stepper → וודא טווח 1-20
10. [ ] לחץ EMOM על תרגיל → וודא שהכפתור משתנה לסגול
11. [ ] לחץ X להסרת תרגיל → וודא שנמחק מהרשימה
12. [ ] הזן כותרת בשדה הכותרת
13. [ ] לחץ "התחל אימון"
14. [ ] וודא: ActiveWorkoutScreen נפתח עם מספר סטים ריקים כפי שהוגדר
15. [ ] וודא: תרגיל עם 5 סטים מציג 5 שורות ריקות
16. [ ] וודא: תרגיל עם 1 סט מציג שורה אחת ריקה
17. [ ] החלף חזרה ל-tab "ספרייה" → וודא שהכל עובד כרגיל (אין רגרסיה)
18. [ ] במצב programMode → וודא שה-tab לא מוצג
19. [ ] במצב addToWorkout → וודא שה-tab לא מוצג
```
