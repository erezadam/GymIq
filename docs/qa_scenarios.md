...
## 🤖 בדיקות E2E אוטומטיות (Playwright)

> **תיעוד מלא:** ראה `e2e/README.md`

### קבצי בדיקה

| קובץ | תיאור | בדיקות |
|------|-------|--------|
| `auth.spec.ts` | התחברות והתנתקות | 4 |
| `dashboard.spec.ts` | דשבורד וניווט | 6 |
| `workout-flow.spec.ts` | זרימת אימון מלאה | 8 |
| `workout-history.spec.ts` | היסטוריית אימונים | 5 |
| `trainer-dashboard.spec.ts` | דשבורד מאמן והרשאות | 5 |
| `trainer-trainee-flows.spec.ts` | זרימות מאמן-מתאמן | ~40 |

### תרחישי E2E אוטומטיים

#### תרחיש O: זרימת אימון מלאה (Playwright)
```
1. [✓] התחברות כמשתמש רגיל
2. [✓] ניווט לספריית תרגילים
3. [✓] בחירת תרגילים
4. [✓] התחלת אימון
5. [✓] דיווח סטים
6. [✓] סיום אימון → "סיים" → "כן, סיים" → "שמור וסיים"
7. [✓] אימות שמירה בהיסטוריה כ-"הושלם"
```

#### תרחיש P: מאמן יוצר אימון → מתאמן מבצע (Playwright)
```
1. [✓] מאמן מתחבר
2. [✓] יצירת אימון standalone עם 4 תרגילים משרירים שונים
3. [✓] התנתקות (כולל IndexedDB)
4. [✓] מתאמן מתחבר
5. [✓] ביצוע אימון עם דיווח סטים
6. [✓] סיום אימון מלא
7. [✓] אימות שהאימון מופיע בהיסטוריה כ-"הושלם"
8. [✓] מאמן מתחבר ורואה את אימון המתאמן
```
...
| `npx playwright test --headed` | עם דפדפן פתוח |
| `npx playwright test --ui` | ממשק UI אינטראקטיבי |
| `npx playwright test trainer-trainee-flows.spec.ts` | רק בדיקות מאמן-מתאמן |

### באגים שתוקנו ב-E2E

| באג | תיאור | תיקון |
|-----|-------|-------|
| #E01 | Selectors שגויים למודל סיום | עודכנו ל-"סיים", "כן, סיים", "שמור וסיים" |
| #E02 | Firebase Auth נשאר ב-IndexedDB | ניקוי IndexedDB בהחלפת משתמשים |
| #E03 | אימון נשאר "בתהליך" | תוקן על ידי selectors נכונים |
