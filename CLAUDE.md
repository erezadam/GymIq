...
```
══════════════════════════════════════════════════════════════════════════════
עדכון אחרון: 26/06/2026 | PR #150 — "בורר מקור תרגילים" PR-3: בורר מקור (performed/all) גלוי למשתמש + שער פורש מחדש (לא חוסם את הטופס) + מצב 'all' לא תלוי בקריאת performed.
══════════════════════════════════════════════════════════════════════════════
```
